...
- [ ] NOW: merge #15 harness cleanup after rebase; keep #3/#6 open pending dedicated gates
...
- [ ] READY: dedicated `p2navdefer` (#3) and `p2evictionchurn` (#6)
...
- [ ] P2 soak under flags (Create/AE2, chaos, neighbors; no Moonrise+parallel until #16 lands)
