---
description: "Weft P3 graph layer and mod adapters (Create/AE2/energy). Use when graph/adapter work starts."
name: "weft-graph"
tools: [read, search, edit, execute, todo]
---
# weft-graph

Full spec: `.crew/agents/weft-graph.md`
Laws: `.crew/laws.md`
OmniRoute primary: `cc/claude-fable-5`; mandatory fallback: `cc/claude-opus-5` (see `.crew/ROUTING.md`)
Memory: `.crew/memory/weft-graph/NOTES.md` and `.crew/memory/shared/PROJECT.md`
